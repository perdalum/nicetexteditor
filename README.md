...
See the HTML manual at [`docs/manual.html`](docs/manual.html).

![This README.md open in NiceTextEditor](screenshot-1.png)
...
- Supports Go To Line from the Edit menu with Command-L, including start/end aliases and clamped out-of-range line numbers.
- Lets you toggle per-window Xcode-style line numbers from the toolbar or View menu with Command-Shift-L.
...
Pipeline command prompts focus the input field automatically. Use Up and Down Arrow in the prompt to move through the global command history shared by all documents.
